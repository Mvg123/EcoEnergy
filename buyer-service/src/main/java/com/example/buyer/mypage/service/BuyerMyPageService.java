package com.example.buyer.mypage.service;
...
import com.example.buyer.mypage.model.User; // ★ seller 패키지의 User를 사용해야 함
import com.example.buyer.mypage.repository.SubManagerRepository;
import com.example.buyer.mypage.repository.UserRepository; // ★ seller 패키지의 Repo를 사용해야 함
import com.example.buyer.util.Sha512Util;
